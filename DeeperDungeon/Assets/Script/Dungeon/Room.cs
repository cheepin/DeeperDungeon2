    ...
    public void SetupRoom(IntRange widthRange, IntRange heightRange, int columns, int rows, Corridor corridor)
    {
        ...
        switch (corridor.direction)
        {
            ...
            case Direction.North:
                ...
                roomHeight = Mathf.Clamp(roomHeight, 1, rows - corridor.EndPositionY-limitHeight);
				roomWidth = Mathf.Clamp(roomWidth, 1, columns - corridor.EndPositionX-limitWidth);
					roomWidth = Mathf.Clamp(roomWidth, 1, corridor.EndPositionX-limitWidth);
            ...
            case Direction.East:
                roomHeight = Mathf.Clamp(roomHeight, 1, rows - corridor.EndPositionY-limitHeight);
                roomHeight = Mathf.Clamp(roomHeight, 1, corridor.EndPositionY-limitHeight);
                roomWidth = Mathf.Clamp(roomWidth, 1, columns - corridor.EndPositionX-limitWidth);
